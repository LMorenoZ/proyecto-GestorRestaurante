                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="ingresar(email, pass)">
                        <div class="form-group ">
                            ...
                            <input type="email" class="form-control custom-input" id="inputEmail"
                                placeholder="Ingresa tu correo electrónico" v-model="email">
                        </div>
                        <div class="form-group mt-3">
                            <label for="inputPass" class="fw-bolder">Contraseña:</label>
                            <input type="password" class="form-control custom-input" id="inputPass"
                                placeholder="Ingresa tu contraseña" v-model="pass">
                        </div>
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <div>
                                <div>
    <button type="submit" class="btn btn-success btn-submit">Iniciar Sesión</button>
</div>
</div>

                            <div>
                                <label class="forgot-password">¿Olvidó su contraseña?</label>
                            </div>
                        </div>
                    </form>
                </div>
...
.circle-background {
    ...
    background-image: url('C:\Users\jac-c\Desktop\Proyecto Restaurante\proyecto-GestorRestaurante/img1.jpg');
